      ...
      <div className="App w-[100vw] h-[100vh] bg-gray-50 dark:bg-gray-800 pt-2">
        <div className='container mx-auto text-center pt-2 px-1'>

          {
            index === 0 ?
              <>
                <h1 className="text-4xl font-extrabold leading-none tracking-tight text-gray-900  dark:text-white uppercase mb-2">Gương chiếu Yêu</h1>
                <a
                  target='_blank'
                  href="https://ngotannhat.blogspot.com/2024/04/kinh-chieu-yeu-minh-nghich-dua-tren-y.html"
